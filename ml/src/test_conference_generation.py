...
def generate_conference(request: GenerateConferenceRequest) -> ConferenceProfile:
    ...
    prompt = (
        ...
        "Поля JSON:\n"
        "- name: Уникальное название конференции на АНГЛИЙСКОМ языке. Название должно быть:\n"
        "  * Креативным и запоминающимся\n"
        "  * Отражать специфику ниши {niche_name}\n"
        "  * Может включать слова 'Conference', 'Summit', 'Forum', но они должны быть частью более креативного названия\n"
        "  * Включать уникальные элементы, связанные с технологиями\n"
        "  * Быть коротким (2-4 слова) и ёмким\n"
        "  * Использовать современную техническую терминологию\n"
        "  * Избегать клише и общих фраз\n"
        "  * СТРОГО ЗАПРЕЩЕНО использовать простые названия вида 'Niche Conference' или 'Niche Summit'\n"
        "  * СТРОГО ЗАПРЕЩЕНО использовать только название ниши с суффиксом\n"
        "  * СТРОГО ЗАПРЕЩЕНО использовать шаблонные комбинации\n"
        ...
        "- Medical Horizon Conference\n"
        "- BioTech Evolution Forum\n"
        "- Health Pulse\n"
        "- Medical Core\n"
        "- Future Health\n"
        "- Bio Nexus\n\n"
        ...
        "- Cosmic Horizon Conference\n"
        "- Star Tech Forum\n"
        "- Space Pulse\n"
        "- Cosmic Core\n"
        "- Future Space\n"
        "- Star Nexus\n\n"
        "ВАЖНО: Эти примеры показывают СТИЛЬ названий. Вы ДОЛЖНЫ генерировать СВОИ уникальные названия в похожем стиле. НЕ используйте эти примеры напрямую, а создавайте новые названия, следуя их стилю и формату.\n"
        "СТРОГО ЗАПРЕЩЕНО генерировать простые названия вида:\n"
